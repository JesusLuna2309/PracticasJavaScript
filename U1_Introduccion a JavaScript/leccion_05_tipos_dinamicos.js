let miVariable = 10; // Declaración de una variable con let
console.log("Tipo de variable miVariable:", typeof miVariable); // Imprime "number"

miVariable = "Hola"; // Reasignación de la variable a un tipo diferente
...
console.log("Nuevo tipo de variable miVariable:", typeof miVariable); // Imprime "object
...
let numeroString = "10"; // Conversión de number a string
let resultado = numero + numeroString; // Suma de un número y un string
...
console.log("Resultado de la suma:", resultadoSuma); // Imprime 15